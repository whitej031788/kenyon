...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function __construct() {
        ...
        // set default dirs
        $this->setTemplateDir('view/smarty/templates/')
                ->setCompileDir('view/smarty/templates_c/')
                ->setPluginsDir('view/smarty/plugins/')
                ->setCacheDir('view/smarty/cache/')
                ->setConfigDir('view/smarty/configs/');
