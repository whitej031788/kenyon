<?php /* Smarty version Smarty-3.1.17, created on 2015-02-21 02:50:47
         compiled from "view/smarty/templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175684451054e35c103bc482-04190171%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '459c47e9704cb0965bdb340b7087ab87de686439' => 
    array (
      0 => 'view/smarty/templates/index.tpl',
      1 => 1424487045,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '175684451054e35c103bc482-04190171',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_54e35c10412533_81323670',
  'variables' => 
  array (
    'BadReg' => 0,
    'isLive' => 0,
...
<?php if ($_valid && !is_callable('content_54e35c10412533_81323670')) {function content_54e35c10412533_81323670($_smarty_tpl) {?><!DOCTYPE html>  
<html>  
    <head>   
    ...
    <body>  
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav" style="padding:10px !important;">
                        <li <?php if (!isset($_smarty_tpl->tpl_vars['BadReg']->value)||$_smarty_tpl->tpl_vars['BadReg']->value!='True') {?>class="active"<?php }?> id="logli"><a href="#" onclick="toggleNav('login');">Login</a></li>
                        <li <?php if (isset($_smarty_tpl->tpl_vars['BadReg']->value)&&$_smarty_tpl->tpl_vars['BadReg']->value=='True') {?>class="active"<?php }?> id="regli"><a href="#" onclick="toggleNav('register');">Register</a></li>
        ...
        <div class="modal-dialog" style="padding-top:110px;">
            <div class="modal-content" id="modlogin" <?php if (isset($_smarty_tpl->tpl_vars['BadReg']->value)&&$_smarty_tpl->tpl_vars['BadReg']->value=='True') {?>style="display:none;"<?php }?>>
                <div class="modal-header">
                    <h1 class="text-center">Kenyon Login</h1>
                </div>
                <div class="modal-body">
                    <?php if (isset($_smarty_tpl->tpl_vars['isLive']->value)&&$_smarty_tpl->tpl_vars['isLive']->value==1) {?>
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['badLog']->value)&&$_smarty_tpl->tpl_vars['badLog']->value=='true') {?><span style="font-size:10pt; font-family:Century Gothic, Arial, Courier New, Sans-Serif;color:red;text-decoration:italics;">We do not
                                show that as a valid login. Please contact the site admin to have your password reset or use the <a href="#" class="forPass">Forgot Password</a> link.</span><br /><?php }?><br />
                ...
                <div class="modal-content" id="modreg"  <?php if (!isset($_smarty_tpl->tpl_vars['BadReg']->value)||$_smarty_tpl->tpl_vars['BadReg']->value!='True') {?>style="display:none;"<?php }?>>
                    <div class="modal-header">
                        <h1 class="text-center">Friends Register</h1>
                    </div>
                    <div class="modal-body">
                        <?php if (isset($_smarty_tpl->tpl_vars['isLive']->value)&&$_smarty_tpl->tpl_vars['isLive']->value==1) {?>
                            <?php if (isset($_smarty_tpl->tpl_vars['BadReg']->value)&&$_smarty_tpl->tpl_vars['BadReg']->value=='True') {?><span style="font-size:10pt; font-family:Century Gothic, Arial, Courier New, Sans-Serif;color:red;text-decoration:italics;">There was a problem with 
                                    your registration; either we do not have you as a registered friend, which means you need to <a href="#" onclick="toggleNav('join');">Join Up</a>, or you already have a valid login. Contact the site admin with questions.</span><br /><br /><?php }?>
